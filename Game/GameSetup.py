...
class GameSetup:
    ...
    def show_instructions(self):
        ...
        instructions_text = (
            ...
            "Rules:\n"
            "The game board is a square grid filled with numbers from 1 to 9. Two players take turns clicking one of "
            ...
            "Greedy, Safe Choice, Monte Carlo Tree Search or Minimax.\n"
